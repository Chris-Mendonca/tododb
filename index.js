...
mongoose.connect("mongodb+srv://chrismendonca:chrisam2002@cluster0.lbnmv1o.mongodb.net/tododb",{useNewUrlParser:true})
...
const t2=new todomodel({task:"wroking out"})
const t3=new todomodel({task:"studying"})
const t4=new todomodel({task:"going"})
